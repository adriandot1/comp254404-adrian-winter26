...
public class LinkedPositionalList<E> implements PositionalList<E> {
   ...
   *
   * This implementation uses only the PositionalList interface methods.
   *
   * @param p   a Position of the list
   * @return the index of Position p, or -1 if p is not found
   */
  @Override
  ...
  public static void main(String[] args) {
    ...
    Position<String> first = list.addLast("A");
    Position<String> second = list.addLast("B");
    Position<String> third = list.addLast("C");

    System.out.println("List: " + list);
    System.out.println("indexOf(A): " + list.indexOf(first));
    System.out.println("indexOf(B): " + list.indexOf(second));
    System.out.println("indexOf(C): " + list.indexOf(third));

    Position<String> inserted = list.addBefore(third, "X");
    System.out.println("\nAfter Insertion: " + list);
    System.out.println("indexOf(X): " + list.indexOf(inserted));
    System.out.println("indexOf(C): " + list.indexOf(third));

    list.remove(inserted);
    System.out.println("\nAfter removing X: " + list);
    System.out.println("indexOf(X): " + list.indexOf(inserted));
  }
}
